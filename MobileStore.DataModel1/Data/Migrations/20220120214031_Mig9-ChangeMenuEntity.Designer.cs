...
namespace MobileStore.DataModelLayer1.Data.Migrations
{
    ...
    [Migration("20220120214031_Mig9-ChangeMenuEntity")]
    partial class Mig9ChangeMenuEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MobileStore.DataModelLayer.Models.ProductEntity", b =>
                {
                    b.HasOne("MobileStore.DataModelLayer1.Models.MenuEntity", "Menu")
                        .WithMany("Product")
                        .HasForeignKey("Product_MenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
